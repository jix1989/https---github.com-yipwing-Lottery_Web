...
<body>
    ...
    <div>
        <form id="frm_payment" action="Send.aspx" method="post" class="democss" target="_blank">
        <div>
                ...
                <label>
                    <table width="100%" border="0" cellspacing="0" cellpadiving="0" style="text-align: left;">
                        ...
                        <tr id="tr12">
                            ...
                            <td>
                                <input type="radio" name="rtype" value="1006" />支付宝Wap
                            </td>
                            <td>
                        ...
                        <tr id="tr13">
                            <td>
                                <input type="radio" name="rtype" value="1004" />微信支付
                            </td>
                            <td>
                                 <input type="radio" name="rtype" value="1007" />微信支付Wap
                            </td>
                             <td>
                                  <input type="radio" name="rtype" value="2097" />网银WAP
                            </td>
                            <td>
            ...
            <div>
                <label>
                    <input name="txtUserName" type="text" id="txtUserName" size="20" value="test" class="input" />
                </label>
                <font class="red">*</font>
            </div>
            <div>
            ...
            <div>
                <label>
                    <input name="txtUserName2" type="text" id="txtUserName2" size="20" value="test" class="input" />
                </label>
                <font class="red">*</font>
            </div>
            <div>
                金额：</div>
            <div>
                <input name="PayMoney" type="text" id="PayMoney" maxlength="9" value="10" class="input"
        ...
        <div style="color: #c9b10f;  font-family: Arial, Helvetica, sans-serif,'宋体';">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <input name="cardNo" type="text" id="txtcardNo" size="20" value="1601142397913407" class="input" /><font
                            class="red">&nbsp;*&nbsp;</font>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input name="cardPwd" type="text" id="txtcardpwd" size="20" value="1365100449242435" class="input" /><font
                            class="red">&nbsp;*&nbsp;</font>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input name="txtUserNameCard" type="text" id="txtUserNameCard" size="20" value="test"
                ...
                <tr>
                    ...
                    <td>
                        <input name="txtUserNameCard2" type="text" id="txtUserNameCard2" size="20" value="test"
                            class="input" /><font class="red">&nbsp;*&nbsp;</font>
                    </td>
                </tr>
                <tr>
